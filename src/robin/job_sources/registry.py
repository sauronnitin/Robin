...
from robin.job_sources import health as health_mod
from robin.job_sources.adapters.ats import (
    AshbyAdapter,
    GreenhouseAdapter,
    LeverAdapter,
...
from robin.job_sources.adapters.community import (
    GithubAdapter,
    HackerNewsAdapter,
    RedditAdapter,
    SerpapiAdapter,
)
from robin.job_sources.adapters.open_feeds import (
    ArbeitnowAdapter,
    FourdayweekAdapter,
    FreehireAdapter,
    HimalayasAdapter,
